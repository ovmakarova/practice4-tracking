...
## Инструкция по выполнению работы
  ...
  2. Сделать fork репозитория
     <https://github.com/Itseez-NNSU-SummerSchool2015/practice4-tracking> (в
     ...
     <https://github.com/github-account/practice4-tracking>
     (origin-репозиторий).
  ...
  3. Клонировать [origin][origin] репозиторий к себе на локальный компьютер,
    ...
    ```
    $ git clone https://github.com/github-account/practice4-tracking
    ```

  4. Указать адрес upstream-репозитория:

    ```
    $ git remote add upstream https://github.com/Itseez-NNSU-SummerSchool2015/practice4-tracking
    ```
...
[origin]: https://github.com/github-account/practice4-tracking
